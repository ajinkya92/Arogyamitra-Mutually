...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = (UIScreen.main.bounds.width)/2 + 100 // Changed from 270.0 to take screen width Kalpesh
    public static var leftBezelWidth: CGFloat? = 16.0
    public static var contentViewScale: CGFloat = 1.0  // Changed from 0.96 to 1.0 to remove Effect Kalpesh
